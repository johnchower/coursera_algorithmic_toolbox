...
silent only
cd ~/Projects/coursera_algorithmic_toolbox
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +14 APlusB.py
badd +2 APlusB_test_input.txt
badd +1 compute_fib.py
badd +1 compute_fib_test_input.txt
argglobal
silent! argdel *
edit compute_fib.py
...
wincmd w
argglobal
edit compute_fib_test_input.txt
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
